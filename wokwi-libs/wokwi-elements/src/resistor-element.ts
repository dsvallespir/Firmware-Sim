...
// El viewBox es 0 0 15.645 3
// Factor de escala para que el ancho final sea 58.8px: 58.8 / 15.645 ≈ 3.759
// Altura resultante: 3 * 3.759 ≈ 11.277px
const SVG_WIDTH = 15.645;
const SVG_HEIGHT = 3;
const HOST_WIDTH = 58.8;
const SCALE = HOST_WIDTH / SVG_WIDTH; // ≈ 3.759
const HOST_HEIGHT = SVG_HEIGHT * SCALE; // ≈ 11.28
...
export class ResistorElement extends LitElement {
  /**
   * Resistance value, in ohms. The value is reflected in the color of the bands, according to
   * standard electronic color code.
   */
  @property() value = '1000';

  readonly pinInfo: ElementPin[] = [
    { name: '1', x: 0, y: HOST_HEIGHT / 2, signals: [] },
    { name: '2', x: HOST_WIDTH, y: HOST_HEIGHT / 2, signals: [] },
  ];
